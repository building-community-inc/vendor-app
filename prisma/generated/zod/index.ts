...
export const UserScalarFieldEnumSchema = z.enum(['id','firstName','lastName','hasImage','imageUrl','image','address1','address2','city','stateProvince','postalCode','country','email','phone','businessName','instagramHandle','createdAt','updatedAt','role']);
