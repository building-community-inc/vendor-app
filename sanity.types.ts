...
// Source: ./app/dashboard/markets/[id]/select-preferences/_components/createETransferBooking.ts
// Variable: MARKET_BOOKING_QUERY
// Query: *[_type == "market" && _id == $id] [0] {      vendors,      daysWithTables,      _id    }
export type MARKET_BOOKING_QUERYResult = {
  vendors: Array<{
    vendor: {
      _ref: string;
      _type: "reference";
